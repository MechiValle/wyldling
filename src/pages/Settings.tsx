...
export function Settings() {
  ...
  async function handleFileSelected(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      showToast(
        "That file could not be read. Please make sure it's a valid Wyldling progress file.",
      );
    }
      ...
      <div className='grid grid-cols-[repeat(auto-fill,minmax(280px,1fr))] gap-4'>
        <div className='border-2 border-sage-meadow rounded-xl p-4'>
          ...
          <p className='text-sm mb-4'>
            Your checkmarks are saved only in this browser. If you clear your
            browser data or switch devices, they'll be lost unless you back them
            up first. Download a backup file now, and restore it later on any
            device.
          </p>
